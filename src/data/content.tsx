...
export const transversalSkills: SkillArticle[] = [
  {
    ...
    presentation: (
      <>
        ...
        <p>J'apprécie particulièrement cette forme de travail, car elle incite à se dépasser, à chercher des solutions par soi-même, tout en restant ouvert aux retours extérieurs. En entreprise, ce confort de l'autonomie est régulièrement bousculé : on doit apprendre à composer avec les délais, les priorités et les attentes d'une équipe. Mais c'est aussi dans ces moments-là que le recours à l'autre prend tout son sens. Il permet non seulement de débloquer une situation rapidement, mais aussi de découvrir d'autres manières de penser, d'analyser un problème ou d'aborder une solution.</p><br></br>
  ...
  },
  {
    ...
    overview: (
      <p>J'ai choisi ici de mettre en avant une compétence qui m'est essentielle, tant sur le plan humain que professionnel : ma capacité à m'adapter. <br></br>Dans mon parcours, cette qualité s'est révélée indispensable à plusieurs reprises, et elle continue de guider ma manière d'évoluer dans différents contextes. S'adapter, selon moi, c'est faire face à une situation nouvelle en apprenant à s'y habituer rapidement et efficacement. <br></br><br></br>C'est un réflexe fondamental de l'apprentissage humain, présent dès l'enfance : qu'il s'agisse de marcher, de parler ou d'accomplir des gestes simples, chaque nouvelle étape implique un effort d'ajustement. <br></br>Je souhaite ici explorer cette compétence dans le cadre de mon parcours, en montrant comment elle s'est manifestée dans des environnements très divers. <br></br><br></br>-Une compétence ancrée dans le parcours humain et sportif - Avant même d'en faire l'expérience dans un cadre professionnel, j'ai développé cette capacité d'adaptation dans ma vie personnelle, notamment à travers le sport. Dès mon plus jeune âge, j'ai pratiqué de nombreuses disciplines : basket, football, football américain, boxe… Chaque nouveau sport impliquait une remise à zéro : comprendre les règles, assimiler les techniques, s'intégrer à une nouvelle dynamique de groupe. J'accordais une grande importance à la curiosité dans cet apprentissage. Car pour s'adapter véritablement à un environnement, il ne suffit pas de le subir : il faut s'y intéresser, l'analyser, chercher à s'y améliorer.</p>
    ),
    implementationContext: (
  ...
  },
  {
    ...
    explanation: (
      <>
        <p>Même si je n'ai pas encore eu l'occasion de travailler entièrement sur un projet international, j'ai déjà été confronté à des situations exigeantes en anglais. Je me souviens notamment d'une réunion qui a eu lieu seulement deux jours après mon arrivée sur un nouveau projet. En phase d'avant-vente, j'ai été invité à une réunion client avec mon chef de projet et un interlocuteur allemand. À ma grande surprise, cette réunion s'est tenue intégralement en anglais, et j'ai dû présenter mon travail devant le client, sans préparation préalable.</p><br></br>
        <p>Bien que mon niveau d'anglais soit bon, cette situation inédite a été source de stress. À la question : "Do you speak English well?", j'ai instinctivement répondu "Just a little", par modestie, alors que j'aurais pu affirmer davantage mes compétences. Avec du recul, je sais que j'aurais dû me montrer plus affirmé, car assumer ce rôle, même dans une langue étrangère, fait partie intégrante du métier.</p><br></br>
